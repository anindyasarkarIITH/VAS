...
How to train the Policy Network :
    python vas.py
        ...
        --batch_size 8 (more is better)
        --data_dir directory to contain data file
        --alpha 0.6
"""
import os
import random
...
parser.add_argument('--data_dir', default='/home/research/Visual_Active_Search_Project/EfficientObjectDetection/', help='data directory')
